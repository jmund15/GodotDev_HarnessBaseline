...
**Verified:** 2026-07-09 memory-claim audit — fix live in code: clear at `CastChargeState.cs:172` (OnEnter), publish at `:655`, ordering comment at `:311`; `CastReleaseState.cs:148` reads the key.
