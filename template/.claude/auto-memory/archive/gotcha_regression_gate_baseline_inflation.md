...
**Verified this session (2026-07-03):** Integration baseline jumped `750 → 786` (+36) in a commit whose entire test delta was ONE file (one test file, 1 test). The honest count was 753 = 750 + the session's 3 legit additions.
