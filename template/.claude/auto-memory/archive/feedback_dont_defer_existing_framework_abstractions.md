...
The Phase 1.5 refactor-parity audit caught the omission as a regression vs the deleted FreezeState. Without the audit, Player freeze would have shipped without the "hurt" animation playing.
