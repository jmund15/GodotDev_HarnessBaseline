...
**Concrete (2026-05-17):** an unfiltered test folder had 37 tests across 7 files. Running with that folder's own filter surfaced 9 failures (6 new, 3 pre-existing) that the Logic/Integration/Sanity filters never touched. Fix landed as a folder rename into `Tests/Integration/` + namespace update, bringing the Integration baseline 291 → 328. No new filter was added because the contents were genuinely integration-shape tests mis-categorized.
